    ...
    <div className="flex mobile:flex-col">
      <div className="flex flex-grow flex-col gap-4 max-w-sm">
        <Typography variant="main-title" bold>
          {l10n.getString(
            'onboarding-stay_aligned-relaxed_body_angles-standing-title'
          )}
        </Typography>
        <div className="flex flex-col gap-2">
          <Typography color="secondary">
            {l10n.getString(
              'onboarding-stay_aligned-relaxed_body_angles-standing-step-0'
            )}
          </Typography>
          <Typography color="secondary">
            {l10n.getString(
              'onboarding-stay_aligned-relaxed_body_angles-standing-step-1'
            )}
          </Typography>
        </div>
