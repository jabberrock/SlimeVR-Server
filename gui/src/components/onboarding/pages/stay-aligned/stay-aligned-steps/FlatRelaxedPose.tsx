    ...
    <div className="flex mobile:flex-col">
      <div className="flex flex-grow flex-col gap-4 max-w-sm">
        <Typography variant="main-title" bold>
          {l10n.getString(
            'onboarding-stay_aligned-relaxed_body_angles-flat-title'
          )}
        </Typography>
        <div className="flex flex-col gap-2">
          <Typography color="secondary">
            {l10n.getString(
              'onboarding-stay_aligned-relaxed_body_angles-flat-step-0'
            )}
          </Typography>
          <Typography color="secondary">
            {l10n.getString(
              'onboarding-stay_aligned-relaxed_body_angles-flat-step-1'
            )}
          </Typography>
        </div>
      ...
      <div className="flex flex-col pt-1 items-center fill-background-50 justify-center px-12">
        <img
          src="/images/reset-flat-pose.webp"
          width={200}
          alt="Reset position"
        />
      </div>
