...
import solarxr_protocol.data_feed.StayAlignedPose

/**
 * Detects the pose of trackers in a skeleton.
 */
enum class TrackerSkeletonPose(val serialized: Int) {
	UNKNOWN(StayAlignedPose.UNKNOWN),
	STANDING(StayAlignedPose.STANDING),
	SITTING_IN_CHAIR(StayAlignedPose.SITTING_IN_CHAIR),
	SITTING_ON_GROUND(StayAlignedPose.SITTING_ON_GROUND),
	LYING_ON_BACK(StayAlignedPose.LYING_ON_BACK),
	KNEELING(StayAlignedPose.KNEELING),
	;
