...
class StayAlignedTrackerState(
	...
	// Java accessors because Java cannot access Kotlin value classes
	val yawCorrectionInDeg
		get() = yawCorrection.yaw.toDeg()
	val lockedErrorInDeg
		get() = yawErrors.lockedError.toDeg()
	val centerErrorInDeg
		get() = yawErrors.centerError.toDeg()
	val neighborErrorInDeg
		get() = yawErrors.neighborError.toDeg()
}
